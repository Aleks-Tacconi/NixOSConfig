    ...
    ColumnLayout {
        ...
        Item {
            ...
            StyledListView {
                ...
                touchpadScrollFactor: Config.options.interactions.scrolling.touchpadScrollFactor * 2.2
                mouseScrollFactor: Config.options.interactions.scrolling.mouseScrollFactor * 2.2
                ...
                function followStreamingBottom() {
                    ...
                    // Critical rule:
                    // while streaming, contentY is monotonic.
                    // It can move down, but never up.
