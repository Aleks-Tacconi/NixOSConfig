...
MouseArea {
    ...
    property bool useThumbnail: Images.isValidImageByName(fileModelData.fileName) || fileModelData.fileName.endsWith(".gif")
    property var imageSource: fileModelData.fileUrl || fileModelData.filePath
