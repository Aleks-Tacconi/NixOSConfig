...
RowLayout {
    ...
    readonly property color iconBackgroundColor: "#181818"
    readonly property color iconForegroundColor: "#f5f5f5"
    readonly property color inputBackgroundColor: "#181818"
    ...
    Rectangle {
        ...
        MaterialSymbol {
            ...
            color: root.iconForegroundColor
    ...
    ToolbarTextField { // Search box
        ...
        colBackground: root.inputBackgroundColor
