...
RippleButton {
    ...
    readonly property color idleForegroundColor: "#f5f5f5"
    readonly property color mutedForegroundColor: "#8f8f8f"
    readonly property color activeBackgroundColor: "#262626"
    readonly property color actionHoverColor: "#202020"

    implicitHeight: rowLayout.implicitHeight + root.buttonVerticalPadding * 2
    implicitWidth: rowLayout.implicitWidth + root.buttonHorizontalPadding * 2
    buttonRadius: 6
    colBackground: (root.down || root.keyboardDown) ? root.activeBackgroundColor :
        (selected ? root.activeBackgroundColor : "transparent")
    colBackgroundHover: root.activeBackgroundColor
    colRipple: "#2f2f2f"
    property color colForeground: root.idleForegroundColor

    readonly property string highlightPrefix: `<u><font color="#ffffff">`
                ...
                Loader { // Checkmark for copied clipboard entry
                    ...
                    sourceComponent: Rectangle {
                        ...
                        MaterialSymbol {
                            ...
                            color: root.idleForegroundColor
                        }
                    }
                }
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: RippleButton {
                    ...
                    colBackgroundHover: root.actionHoverColor
                    colRipple: root.activeBackgroundColor
