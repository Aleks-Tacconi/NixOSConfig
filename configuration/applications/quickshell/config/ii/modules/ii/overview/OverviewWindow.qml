...
Item { // Window
    ...
    readonly property color previewHoverColor: "#20202099"
    readonly property color previewActiveColor: "#262626b3"
    readonly property color previewBorderColor: "#2f2f2fdd"
    ...
    ScreencopyView {
        ...
        Rectangle {
            ...
            bottomRightRadius: root.bottomRightRadius
            bottomLeftRadius: root.bottomLeftRadius
            color: pressed ? root.previewActiveColor : hovered ? root.previewHoverColor : "#00000044"
