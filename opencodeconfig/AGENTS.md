...
- The following is a description of available subagents and when to use them
  - context-gatherer: Use for exploring the codebase, prefer this subagent over manually reading files / searching for context
  - implementation-planner: Use for deciding next-steps before proceeding with an implementation, this should be the first subagent ran before proceeding with any code changes
